...
export const TxReceipt = ({ txResult }: { txResult: TransactionReceipt }) => {
  ...
  return (
    <div className="flex text-sm rounded-lg peer-checked:rounded-b-none min-h-0 bg-secondary py-0">
      ...
      <div className="flex-wrap collapse collapse-arrow">
        ...
        <div className="collapse-content overflow-auto bg-secondary rounded-t-none rounded-lg !pl-0">
